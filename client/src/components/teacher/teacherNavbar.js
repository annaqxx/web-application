...
import { logout } from '../../http/teacherAPI';

const TeacherNavbar = observer(({ activeTab, setActiveTab }) => {
  ...
  return (
    <Navbar bg="dark" variant="dark" expand="lg" className="admin-navbar fixed-top">
      <Container fluid> 
        <Navbar.Brand className="navbar-brand-custom">Панель учителя</Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <Nav.Link 
              ...
              className={`nav-link-custom ${activeTab === 'questions' ? 'active' : ''}`}
            >
              Вопросы
            </Nav.Link>
            <Nav.Link 
